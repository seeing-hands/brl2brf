...
## Supported formats:
* BRF and BRL: relatively standard raw Braille files
* BRA and BAN: Raw Braille formats used primarily for content written in Spanish
* FNZ: Format used by the Focus Braille display's Scratchpad application
* GF: Format generated by the Hims BrailleSense Polaris
* Helptech format: Used by Helptech, formerly Handytech, Braille displays
* KWB (decode only): format generated by older Humanware BrailleNote notetakers
* LDF: Format generated by the Levelstar Icon and APH BraillePlus devices
* Portable Embosser Format (PEF) (decode only)
...
```
python3 brl2brf.py -i -o -sf brl -of brf
```
